...
public class Main{
    ...
    public static void main(String args[]) throws FileNotFoundException, IOException{
        ...
        try {
            ois = new ObjectInputStream(new FileInputStream("objeto.bin"));
            loja = (Loja) ois.readObject();
            loja.listarProdutos(); 
        } catch(Exception e) {
            System.out.println(ANSI_RED + "Arquivo não encontrado!" + ANSI_RESET + "\nLoja inicializando vazia...");
            loja = new Loja();
        } finally {
            if (ois != null) {
                try {
            ...
            switch(opt){
                ...
                case 1:
                    ...
                    try{
                        ...
                        System.out.println(ANSI_RED + "O codigo deve conter apenas numeros!" + ANSI_RESET);
                        scan.next();
                        break;
                    }
                    ...
                    try{
                        ...
                        System.out.println(ANSI_RED + "A quantidade deve conter apenas numeros!" + ANSI_RESET);
                        scan.next();
                        break;
                    }
